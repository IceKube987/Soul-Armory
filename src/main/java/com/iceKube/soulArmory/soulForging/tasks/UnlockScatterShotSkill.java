...
public class UnlockScatterShotSkill extends ForgingTask {
    public UnlockScatterShotSkill() {
        super(new ResourceLocation(SoulArmoryMod.MODID, "unlock_scatter_shot"),
                List.of(
                ...
                (player, stack, level) -> SkillUnlockHelper.unlockSkill(player, stack, level, SoulSkills.SCATTER_SHOT),
